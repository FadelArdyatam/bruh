// app/screens/app/WorkoutHistoryScreen.tsx
"use client"
...
const WorkoutHistoryScreen = () => {
  ...
  if (isLoading && !trainingHistory.length) {
    return (
        ...
        renderItem={({ item }) => (
          <View style={styles.historyItem}>
            ...
            <View style={styles.historyInfo}>
              <Text style={styles.historyWorkoutName}>{item.workout_name}</Text>
              <Text style={styles.historyDate}>{formatDate(item.date)}</Text>
            </View>
            <View style={styles.historyStats}>
              <Text style={styles.historyCalories}>{item.calories_burned.toFixed(0)} kal</Text>
